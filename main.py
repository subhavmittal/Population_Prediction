...
test.generate_coefficients()
print(test.get_polynomial(2000))
print(test.get_polynomial(2005))
print(test.get_polynomial(2010))
print(test.get_polynomial(2015))
print(test.get_polynomial(2023))
root,numsteps = bisection(2000,2024,test.get_polynomial,0.5)
root2,numsteps2 = newton(root,test.get_polynomial,test.get_derivative,10,0.5)
if root2==-1:
